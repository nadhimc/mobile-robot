        ...
        <div className="xl:w-1/2 flex-1 flex flex-col items-center justify-center text-center px-4 lg:px-0">
          ...
          >
            ...
            <rect
              ...
              fill="#18185a"
            />
            <circle cx="662.68956" cy="278.66165" r="4.77694" fill="#18185a" />
            <circle cx="678.6127" cy="278.66165" r="4.77694" fill="#18185a" />
            <circle cx="694.53583" cy="278.66165" r="4.77694" fill="#18185a" />
            <path
            ...
            <rect
              ...
              fill="#18185a"
            />
            <circle cx="662.68956" cy="391.71594" r="4.77694" fill="#18185a" />
            <circle cx="678.6127" cy="391.71594" r="4.77694" fill="#18185a" />
            <circle cx="694.53583" cy="391.71594" r="4.77694" fill="#18185a" />
            <path
            ...
            <rect
              ...
              fill="#18185a"
            />
            <circle cx="662.68956" cy="504.77024" r="4.77694" fill="#18185a" />
            <circle cx="678.6127" cy="504.77024" r="4.77694" fill="#18185a" />
            <circle cx="694.53583" cy="504.77024" r="4.77694" fill="#18185a" />
            <path
